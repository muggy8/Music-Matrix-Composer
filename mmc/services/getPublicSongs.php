<?php
    ...
    $sql="select name, songID, creatorID, public, nps, duration, username from songs inner join users on songs.creatorID = users.userID where public = 1 ORDER BY `songs`.`timeCreated` DESC LIMIT 0 , 30";
